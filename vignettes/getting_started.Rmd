...
`infer_grn()` has many more parameters to choose different models or tweek the association between peaks and genes, but we'll go into this in another vignette.
