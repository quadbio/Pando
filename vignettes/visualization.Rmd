...
```
\
This `tbl_graph` object works with most [igraph](https://igraph.org/) and [`ggraph`](https://tidygraph.data-imaginist.com/index.html) functions for easy graph manipulation and you can use it to make more customized plots:
